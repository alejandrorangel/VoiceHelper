...
import mx.edu.cicese.alejandro.rules.Incident;
import mx.edu.cicese.alejandro.rules.Rules;
...
public class MainActivity extends Activity {
     ...
     */
    private AmplitudeCardView voiceView;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        rulesMotor = new Rules(this);
        EventBus.getDefault().register(this);
        context = this.getApplicationContext();
        startTask(createAudioLogger(), "Voice Tracker");

        voiceView = new AmplitudeCardView(this.context);;
    ...
    public void onEventMainThread(AudioClipLogWrapper event) {
        voiceView.setProgressBarValue((int) event.getCurrentVolume());
        if (event.isTooLoud()){
            rulesMotor.addIncident(Incident.Kind.VOICE);
