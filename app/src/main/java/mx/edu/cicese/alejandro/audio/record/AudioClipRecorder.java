...
public class AudioClipRecorder {
     ...
     *
     * @param numSamplesInBuffer Make the audio buffer size big enough to hold this many
     *                           samples
     */
     ...
     *
     * @param recordingBufferSize  minimum audio buffer size
     * @param readBufferSize       reads a buffer of this size
     * @param bufferIncreaseFactor to increase recording buffer size beyond the minimum needed
     */
    ...
    /**
     * @param audioData will be filled when reading the audio data
     */
